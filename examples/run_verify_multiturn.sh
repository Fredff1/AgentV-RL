...
TASK_NAME=qwen2.5-7b-math-bon128-math500-eval

EXP_NAME=qwen2.5-7b-base-eval-multiturn-1101-2

# ray stop

python /root/workspace/agent-rm/Agent-Verifier/src/run_verify_multiturn.py \
