...
python /root/workspace/agent-rm/Agent-Verifier/src/score_tool_complex_agent.py \
  ...
  --output /root/workspace/agent-rm/datasets/gaokao2023/1015/qwen2.5-7b-math-bon128-gaokao-2023_complex_agent_score2_by_qwen2.5-7b-grpo1014-1-step147.jsonl \
  --record-batch-size 1 \
  --include_full_meta \
  --start_idx 0 \
  --append \
