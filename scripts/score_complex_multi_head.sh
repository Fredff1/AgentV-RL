...
python /root/workspace/agent-rm/Agent-Verifier/src/score_tool_complex_agent_multi_head.py \
  ...
  --output /root/workspace/agent-rm/datasets/math500/1013/qwen2.5-7b-math-bon128-math500-eval-100_complex_agent_score1_by_qwen3-4b-grpo1009-multihead.jsonl \
  --record-batch-size 1 \
  --include_full_meta \
  --start_idx 0 \
  --append \
